                    ...
                    <td align="left">
                        <?php
                            if ( $consultant -> commission > 0 )
                                ...
                                echo number_format ( get_ipd_included_services_sum ( $consultant -> sale_id ) * ( $consultant -> bill_commission / 100 ), 2 );
                        ?>
                    </td>
                </tr>
                <?php
...
<?php if ( count ( $anesthesia_charges ) > 0 ) : ?>
    <table width="100%"
           style="font-size: 9pt; border: none; margin-left: 0; margin-top: 25px; page-break-inside:avoid; margin-bottom: 10px"
           cellpadding="0" border="0">
        <tr style="margin-left: 0">
            <td style="margin-left: 0">
