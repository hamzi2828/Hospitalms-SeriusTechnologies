...
<?php
    $user = get_user ( $requisitions[ 0 ] -> request_from );
    ...
    <tr>
        <td width="100%" style="text-align: right;">
			<span style="font-size: 8pt">
                ...
                <strong>Requisition No:</strong> <?php echo $requisitions[ 0 ] -> requisitions_id ?> <br />
			</span>
        </td>
    </tr>
</table>
...
<table width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8" border="0">
    <tr>
        <td style="width: 100%; background: #f5f6f7; text-align: center">
            <h3><strong> Requisitions (Requests) </strong></h3>
        </td>
    </tr>
</table>
<br />
        ...
        if ( count ( $requisitions ) > 0 ) {
            foreach ( $requisitions as $requisition ) {
                ...
                <tr>
                    ...
                    <td align="left"><?php echo $requisition -> name ?></td>
    ...
    <tr>
        <td align="center" width="33%">
            <p style="font-size: 10pt">
                <strong><?php echo get_user ( $requisitions[ 0 ] -> request_from ) -> name ?></strong>
            </p>
