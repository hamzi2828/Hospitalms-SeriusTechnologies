    ...
    <table width="100%" style="font-size:6pt; border-collapse:collapse;">
        <tr>
            ...
            <td style="width:34%; vertical-align:top;">
                <b>Sahibzada Niamat Ullah</b><br>
                <span style="font-size:6pt;">
                    Microbiologist & Immunologist<br>
                    PhD (RA) Micro & Immuno<br>
                    M.Phil (Mol. Biology), B.Sc MLT Pgd Cytology
                </span>
            </td>
            <td style="width:33%; vertical-align:top;">
                <b>Dr Sabahat Rehman</b><br>
                <span style="font-size:6pt;">
                    Consultant Microbiologist<br>
                    MBBS AMC<br>
                    M.Phil (Microbiology) NUST
                </span>
            </td>
        </tr>
    </table>
