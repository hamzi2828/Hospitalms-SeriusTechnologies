...
<table width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8" border="0">
    <tr>
        <td style="width: 100%; background: #f5f6f7; text-align: center">
            <h3><strong> Disposed Store Fix Assets List </strong></h3>
        </td>
    </tr>
</table>
<table class="items" width="100%" style="font-size: 8pt; border-collapse: collapse; " cellpadding="8" border="1">
    ...
    <tr>
        ...
        <th align="left"> Original Value</th>
        <th align="left"> Disposed Value</th>
        <th align="left"> Disposed Quantity</th>
        <th align="left"> Accumulative Depreciation</th>
        <th align="left"> Dispose Date</th>
    </tr>
    </thead>
    <tbody>
    <?php
