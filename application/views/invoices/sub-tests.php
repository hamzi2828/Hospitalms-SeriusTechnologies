        ...
        foreach ( $sub_tests as $sub_test ) {
            ...
            if ( !empty( $result ) && !empty( trim ( $result -> result ) ) ) {
                ...
                <tr>
                    ...
                    <td align="left" 
                    style="font-weight: 900; font-size: 9pt; <?php if ( $result -> abnormal == '1' ) echo 'color: #FF0000; font-weight: bold'; ?>">
                    <?php
                        if ( $sub_test_info -> category == 'covid' )
                            echo $result -> detected == 'detected' ? 'Detected' : 'Not Detected';
                        else
                            echo $result -> result;
                    ?>
                </td>
                ...
                <?php
                    if ( count ( $sub_previous_results ) > 0 ) {
                        foreach ( $sub_previous_results as $key => $previous_result ) {
                            ?>
                            <td align="left" 
                            style="font-weight: 900; font-size: 9pt; <?php if ( $previous_result -> abnormal == '1' ) echo 'color: #FF0000; font-weight: bold'; ?>">
