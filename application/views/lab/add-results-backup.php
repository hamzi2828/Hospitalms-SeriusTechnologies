        ...
        <form method="get" autocomplete="off">
            ...
            <div class="sale">
                ...
                <div class="form-group col-lg-4" style="position: relative">
                    ...
                    <input type="text" class="form-control" placeholder="<?php echo $this -> lang -> line ( 'PATIENT_NAME' ); ?>"
                           value="<?php echo @get_patient ( $sales[ 0 ] -> patient_id ) -> name ?>" readonly="readonly">
                </div>
                <div class="form-group col-lg-5">
                    <label for="exampleInputEmail1">Date <small
                                style="color: #FF0000"> (Search by specific date if <?php echo $this -> lang -> line ( 'INVOICE_ID' ); ?># not available) </small></label>
