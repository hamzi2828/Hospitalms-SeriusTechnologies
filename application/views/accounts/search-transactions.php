                                ...
                                <?php foreach ( $transactions as $key => $transaction ) : ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-offset-3 col-lg-3">
                                            ...
                                            <select class="form-control select2me" required="required" id="acc-head-id"
                                                    name="acc-head-id[]">
                                                <option value="<?php echo $transaction -> acc_head_id ?>">
                                                    <?php echo get_account_head ( $transaction -> acc_head_id ) -> title ?>
                                                </option>
                                            </select>
                                        </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-9 col-md-offset-3">
                                    <button type="submit" class="btn blue" id="multiple-transactions-btn">Update
                                    </button>
