    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body" style="overflow:auto;">
                <table class="table table-striped table-bordered table-hover" id="ipd-genral-report-panel">
                    <thead>
                    <tr>
                        <th> Sr. No</th>
...
<script type="text/javascript">
    function downloadExcel () {
        // Get the HTML table
        let table = document.getElementById ( "ipd-genral-report-panel" );
        ...
        a.href     = url;
        a.download = "IPD Reporting (Panel).xlsx";
        a.click ();
