    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i> Edit Death Certificate
                </div>
            </div>
            <div class="portlet-body form">
                <form role="form" method="post" autocomplete="off">
                    ...
                    <input type="hidden" name="action" value="edit_death_certificate">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-2" style="position: relative">
                                ...
                                <input type="text" name="patient_id" class="form-control patient-id" id="patient-id"
                                       value="<?php echo $patient -> id ?>" required="required">
                            </div>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" name="death-date" class="form-control date-picker"
                                       ...
                                       value="<?php echo set_value ( 'death-date', $certificate -> death_date ) ?>">
                            </div>
                            <div class="form-group col-lg-3">
                                <label for="death-time">Death Time</label>
                                <input type="time" name="death-time" class="form-control" placeholder="Death Time"
                                       id="death-time"
                                       value="<?php echo set_value ( 'death-time', $certificate -> death_time ) ?>">
                            </div>
                            <div class="form-group col-lg-3">
                                    ...
                                    <?php
                                        if ( count ( $rooms ) > 0 ) {
                                            foreach ( $rooms as $room ) {
                                                ?>
                                                <option value="<?php echo $room -> id ?>" <?php echo $certificate -> room_id == $room -> id ? 'selected="selected"' : '' ?>>
                                                    <?php echo $room -> title ?>
                                                </option>
                                                <?php
                                            }
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <textarea name="death-cause" class="form-control" placeholder="Cause of Death"
                                          id="death-cause" rows="3"><?php echo set_value ( 'death-cause', $certificate -> death_cause ) ?></textarea>
                            </div>
                            <div class="form-group col-lg-3">
                                <label for="diagnosis">Diagnosis</label>
                                <textarea type="text" name="diagnosis" class="form-control"
                                          id="diagnosis" rows="3"><?php echo set_value ( 'diagnosis', $certificate -> diagnosis ) ?></textarea>
                            </div>
                            <div class="form-group col-lg-3">
                                <label for="body-handed-to">Body Handed To</label>
                                <input type="text" name="body-handed-to" class="form-control"
                                       id="body-handed-to"
                                       value="<?php echo set_value ( 'body-handed-to', $certificate -> body_handed_to ) ?>">
                            </div>
                            <div class="form-group col-lg-3">
                                <label for="relation">Relation</label>
                                <input type="text" name="relation" class="form-control"
                                       id="relation"
                                       value="<?php echo set_value ( 'relation', $certificate -> relation ) ?>">
                            </div>
                            <div class="form-group col-lg-3">
                                <label for="cnic">CNIC No</label>
                                <input type="text" name="cnic" class="form-control"
                                       id="cnic"
                                       value="<?php echo set_value ( 'cnic', $certificate -> guardian_cnic ) ?>">
                            </div>
                        </div>
                    </div>
