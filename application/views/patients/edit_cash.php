    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i> Edit Cash Patient
                </div>
            </div>
                                    ...
                                    <?php
                                        if ( count ( $references ) > 0 ) {
                                            foreach ( $references as $reference ) {
                                                ?>
                                                <option value="<?php echo $reference -> id ?>" <?php if ( $reference -> reference_id == $reference -> id )
                                                    echo 'selected="selected"' ?>><?php echo $reference -> title ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
