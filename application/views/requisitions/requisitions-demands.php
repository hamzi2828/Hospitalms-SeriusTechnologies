                                    ...
                                    <td class="btn-group-xs">
                                        <?php if ( !empty( $access ) and in_array ( 'approve_fm_demand', explode ( ',', $access -> access ) ) ) : ?>
                                            <a type="button" class="btn green"
                                               href="<?php echo base_url ( '/FacilityManager/status/' . $requisition -> id . '?status=approved' ) ?>">Approve</a>
                                        <?php endif ?>
                                        
                                        <?php if ( !empty( $access ) and in_array ( 'reject_fm_demand', explode ( ',', $access -> access ) ) ) : ?>
                                            <a type="button" class="btn blue"
                                               href="<?php echo base_url ( '/FacilityManager/status/' . $requisition -> id . '?status=rejected' ) ?>">Reject</a>
                                        <?php endif ?>
                                        
                                        <?php if ( !empty( $access ) and in_array ( 'delete_fm_demand', explode ( ',', $access -> access ) ) ) : ?>
                                            <a type="button" class="btn red"
                                               href="<?php echo base_url ( '/FacilityManager/delete/' . $requisition -> id ) ?>"
