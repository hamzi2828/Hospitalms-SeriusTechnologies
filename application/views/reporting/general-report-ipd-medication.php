            ...
            <form role="form" method="get" autocomplete="off">
                ...
                <div class="form-group col-lg-2">
                    ...
                    <select name="patient-type" class="form-control select2me">
                        ...
                        <option value="cash" <?php if ( @$_REQUEST[ 'patient-type' ] == 'cash' ) echo 'selected="selected"' ?>>
                            Cash
                        </option>
                        <?php
                            if ( count ( $panels ) > 0 ) {
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                ...
                <?php if ( count ( $reports ) > 0 ) : ?>
                    <a href="<?php echo base_url ( '/invoices/general-report-ipd-medication?' . $_SERVER[ 'QUERY_STRING' ] ) ?>"
           ...
           <div class="portlet-body" style="overflow: auto">
                <table class="table table-striped table-bordered table-hover" id="genral-report-ipd-medication">
                    <thead>
                    <tr>
                        <th> Sr. No</th>
...
<script type="text/javascript">
    function downloadExcel () {
        // Get the HTML table
        let table = document.getElementById ( "genral-report-ipd-medication" );
        ...
        a.href     = url;
        a.download = "General Report IPD Medication.xlsx";
        a.click ();
