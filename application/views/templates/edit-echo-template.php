    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-reorder"></i> Edit Template (ECHO)
                </div>
            </div>
            <div class="portlet-body form">
                ...
                <form role="form" method="post" autocomplete="off">
                    ...
                    <input type="hidden" name="action" value="do_edit_echo_template">
                    ...
                    <div class="form-body" style="overflow:auto;">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <textarea class="form-control wysihtml5" placeholder="Add study" name="study" rows="15"
                                      style="height: 100%"><?php echo $template -> study ?></textarea>
                        </div>
    
                        <div class="form-group col-lg-12">
                            <label for="exampleInputEmail1">Conclusion</label>
                            <textarea class="form-control wysihtml5" placeholder="Add conclusion" name="conclusion"
